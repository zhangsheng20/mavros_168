...
typedef struct __mavlink_global_position_int_t
{
 ...
 int32_t relative_alt; /*< Altitusde above ground in meters, expressed as * 1000 (millimeters)*/
 ...
 uint8_t satellites_visible; /*< satellites visible*/
 uint8_t fixed_type; /*< fixed_type*/
} mavlink_global_position_int_t;

#define MAVLINK_MSG_ID_GLOBAL_POSITION_INT_LEN 30
#define MAVLINK_MSG_ID_33_LEN 30

#define MAVLINK_MSG_ID_GLOBAL_POSITION_INT_CRC 190
#define MAVLINK_MSG_ID_33_CRC 190
...
#define MAVLINK_MESSAGE_INFO_GLOBAL_POSITION_INT { \
	...
	{  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_global_position_int_t, time_boot_ms) }, \
         ...
         { "satellites_visible", NULL, MAVLINK_TYPE_UINT8_T, 0, 28, offsetof(mavlink_global_position_int_t, satellites_visible) }, \
         { "fixed_type", NULL, MAVLINK_TYPE_UINT8_T, 0, 29, offsetof(mavlink_global_position_int_t, fixed_type) }, \
         } \
}
 ...
 * @param relative_alt Altitusde above ground in meters, expressed as * 1000 (millimeters)
 * @param vx Ground X Speed (Latitude), expressed as m/s * 100
 * @param vy Ground Y Speed (Longitude), expressed as m/s * 100
 * @param vz Ground Z Speed (Altitude), expressed as m/s * 100
 * @param hdg Compass heading in degrees * 100, 0.0..359.99 degrees. If unknown, set to: UINT16_MAX
 * @param satellites_visible satellites visible
 * @param fixed_type fixed_type
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_global_position_int_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint32_t time_boot_ms, int32_t lat, int32_t lon, int32_t alt, int32_t relative_alt, int16_t vx, int16_t vy, int16_t vz, uint16_t hdg, uint8_t satellites_visible, uint8_t fixed_type)
{
	...
	_mav_put_uint8_t(buf, 29, fixed_type);
...
{
	return mavlink_msg_global_position_int_pack(system_id, component_id, msg, global_position_int->time_boot_ms, global_position_int->lat, global_position_int->lon, global_position_int->alt, global_position_int->relative_alt, global_position_int->vx, global_position_int->vy, global_position_int->vz, global_position_int->hdg, global_position_int->satellites_visible, global_position_int->fixed_type);
}
...
static inline void mavlink_msg_global_position_int_send(mavlink_channel_t chan, uint32_t time_boot_ms, int32_t lat, int32_t lon, int32_t alt, int32_t relative_alt, int16_t vx, int16_t vy, int16_t vz, uint16_t hdg, uint8_t satellites_visible, uint8_t fixed_type)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_GLOBAL_POSITION_INT_LEN];
	_mav_put_uint32_t(buf, 0, time_boot_ms);
 ...
 */
static inline void mavlink_msg_global_position_int_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, int32_t lat, int32_t lon, int32_t alt, int32_t relative_alt, int16_t vx, int16_t vy, int16_t vz, uint16_t hdg, uint8_t satellites_visible, uint8_t fixed_type)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 *
 * @return Altitusde above ground in meters, expressed as * 1000 (millimeters)
 */
...
/**
 * @brief Get field satellites_visible from global_position_int message
 *
 * @return satellites visible
 */
static inline uint8_t mavlink_msg_global_position_int_get_satellites_visible(const mavlink_message_t* msg)
{
	return _MAV_RETURN_uint8_t(msg,  28);
}

/**
 * @brief Get field fixed_type from global_position_int message
 *
 * @return fixed_type
 */
static inline uint8_t mavlink_msg_global_position_int_get_fixed_type(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_global_position_int_decode(const mavlink_message_t* msg, mavlink_global_position_int_t* global_position_int)
{
	...
	global_position_int->satellites_visible = mavlink_msg_global_position_int_get_satellites_visible(msg);
	global_position_int->fixed_type = mavlink_msg_global_position_int_get_fixed_type(msg);
#else
