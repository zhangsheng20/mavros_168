...
typedef struct __mavlink_sys_status_t
{
 ...
 uint16_t total_flight_min; /*< Autopilot-specific errors*/
 uint16_t flight_time; /*< Autopilot-specific errors*/
 uint16_t onboard_time; /*< Autopilot-specific errors*/
 uint16_t errors_count; /*< Autopilot-specific errors*/
...
#define MAVLINK_MSG_ID_SYS_STATUS_CRC 33
#define MAVLINK_MSG_ID_1_CRC 33
...
#define MAVLINK_MESSAGE_INFO_SYS_STATUS { \
	...
	{  { "onboard_control_sensors_present", "0x%04x", MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_sys_status_t, onboard_control_sensors_present) }, \
         ...
         { "total_flight_min", NULL, MAVLINK_TYPE_UINT16_T, 0, 22, offsetof(mavlink_sys_status_t, total_flight_min) }, \
         { "flight_time", NULL, MAVLINK_TYPE_UINT16_T, 0, 24, offsetof(mavlink_sys_status_t, flight_time) }, \
         { "onboard_time", NULL, MAVLINK_TYPE_UINT16_T, 0, 26, offsetof(mavlink_sys_status_t, onboard_time) }, \
         { "errors_count", NULL, MAVLINK_TYPE_UINT16_T, 0, 28, offsetof(mavlink_sys_status_t, errors_count) }, \
 ...
 * @param total_flight_min Autopilot-specific errors
 * @param flight_time Autopilot-specific errors
 * @param onboard_time Autopilot-specific errors
 * @param errors_count Autopilot-specific errors
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_sys_status_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint32_t onboard_control_sensors_present, uint32_t onboard_control_sensors_enabled, uint32_t onboard_control_sensors_health, uint16_t load, uint16_t voltage_battery, int16_t current_battery, int8_t battery_remaining, uint16_t drop_rate_comm, uint16_t errors_comm, uint16_t total_flight_min, uint16_t flight_time, uint16_t onboard_time, uint16_t errors_count)
{
	...
	_mav_put_uint16_t(buf, 22, total_flight_min);
	_mav_put_uint16_t(buf, 24, flight_time);
	_mav_put_uint16_t(buf, 26, onboard_time);
	_mav_put_uint16_t(buf, 28, errors_count);
	...
	packet.total_flight_min = total_flight_min;
	packet.flight_time = flight_time;
	packet.onboard_time = onboard_time;
...
{
	return mavlink_msg_sys_status_pack(system_id, component_id, msg, sys_status->onboard_control_sensors_present, sys_status->onboard_control_sensors_enabled, sys_status->onboard_control_sensors_health, sys_status->load, sys_status->voltage_battery, sys_status->current_battery, sys_status->battery_remaining, sys_status->drop_rate_comm, sys_status->errors_comm, sys_status->total_flight_min, sys_status->flight_time, sys_status->onboard_time, sys_status->errors_count);
}
...
/**
 * @brief Get field total_flight_min from sys_status message
 *
 * @return Autopilot-specific errors
 */
static inline uint16_t mavlink_msg_sys_status_get_total_flight_min(const mavlink_message_t* msg)
{
	return _MAV_RETURN_uint16_t(msg,  22);
}

/**
 * @brief Get field flight_time from sys_status message
 *
 * @return Autopilot-specific errors
 */
static inline uint16_t mavlink_msg_sys_status_get_flight_time(const mavlink_message_t* msg)
{
	return _MAV_RETURN_uint16_t(msg,  24);
}

/**
 * @brief Get field onboard_time from sys_status message
 *
 * @return Autopilot-specific errors
 */
static inline uint16_t mavlink_msg_sys_status_get_onboard_time(const mavlink_message_t* msg)
{
	return _MAV_RETURN_uint16_t(msg,  26);
}

/**
 * @brief Get field errors_count from sys_status message
 *
 * @return Autopilot-specific errors
 */
static inline uint16_t mavlink_msg_sys_status_get_errors_count(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_sys_status_decode(const mavlink_message_t* msg, mavlink_sys_status_t* sys_status)
{
	...
	sys_status->total_flight_min = mavlink_msg_sys_status_get_total_flight_min(msg);
	sys_status->flight_time = mavlink_msg_sys_status_get_flight_time(msg);
	sys_status->onboard_time = mavlink_msg_sys_status_get_onboard_time(msg);
	sys_status->errors_count = mavlink_msg_sys_status_get_errors_count(msg);
