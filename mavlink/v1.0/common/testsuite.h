...
static void mavlink_test_heartbeat(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_heartbeat_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_heartbeat_pack(system_id, component_id, &msg , packet1.type , packet1.autopilot , packet1.base_mode , packet1.custom_mode , packet1.system_status , packet1.rc_status );
	mavlink_msg_heartbeat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_heartbeat_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.type , packet1.autopilot , packet1.base_mode , packet1.custom_mode , packet1.system_status , packet1.rc_status );
	mavlink_msg_heartbeat_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_heartbeat_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_heartbeat_send(MAVLINK_COMM_1 , packet1.type , packet1.autopilot , packet1.base_mode , packet1.custom_mode , packet1.system_status , packet1.rc_status );
	mavlink_msg_heartbeat_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_sys_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_sys_status_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	...
        	packet1.total_flight_min = packet_in.total_flight_min;
        	packet1.flight_time = packet_in.flight_time;
        	packet1.onboard_time = packet_in.onboard_time;
...
static void mavlink_test_global_position_int(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_global_position_int_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	...
        	packet1.satellites_visible = packet_in.satellites_visible;
        	packet1.fixed_type = packet_in.fixed_type;
	...
	mavlink_msg_global_position_int_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_global_position_int_pack(system_id, component_id, &msg , packet1.time_boot_ms , packet1.lat , packet1.lon , packet1.alt , packet1.relative_alt , packet1.vx , packet1.vy , packet1.vz , packet1.hdg , packet1.satellites_visible , packet1.fixed_type );
	mavlink_msg_global_position_int_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_global_position_int_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_boot_ms , packet1.lat , packet1.lon , packet1.alt , packet1.relative_alt , packet1.vx , packet1.vy , packet1.vz , packet1.hdg , packet1.satellites_visible , packet1.fixed_type );
	mavlink_msg_global_position_int_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_global_position_int_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_global_position_int_send(MAVLINK_COMM_1 , packet1.time_boot_ms , packet1.lat , packet1.lon , packet1.alt , packet1.relative_alt , packet1.vx , packet1.vy , packet1.vz , packet1.hdg , packet1.satellites_visible , packet1.fixed_type );
	mavlink_msg_global_position_int_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_vfr_hud(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_vfr_hud_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.rotor1 = packet_in.rotor1;
        	packet1.rotor2 = packet_in.rotor2;
        	packet1.rotor3 = packet_in.rotor3;
        	packet1.rotor4 = packet_in.rotor4;
        	packet1.rotor5 = packet_in.rotor5;
        	packet1.rotor6 = packet_in.rotor6;
        	packet1.rotor7 = packet_in.rotor7;
        	packet1.rotor8 = packet_in.rotor8;
	...
	mavlink_msg_vfr_hud_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vfr_hud_pack(system_id, component_id, &msg , packet1.rotor1 , packet1.rotor2 , packet1.rotor3 , packet1.rotor4 , packet1.rotor5 , packet1.rotor6 , packet1.rotor7 , packet1.rotor8 );
	mavlink_msg_vfr_hud_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vfr_hud_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.rotor1 , packet1.rotor2 , packet1.rotor3 , packet1.rotor4 , packet1.rotor5 , packet1.rotor6 , packet1.rotor7 , packet1.rotor8 );
	mavlink_msg_vfr_hud_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_vfr_hud_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vfr_hud_send(MAVLINK_COMM_1 , packet1.rotor1 , packet1.rotor2 , packet1.rotor3 , packet1.rotor4 , packet1.rotor5 , packet1.rotor6 , packet1.rotor7 , packet1.rotor8 );
	mavlink_msg_vfr_hud_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_altitude(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_altitude_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_altitude_pack(system_id, component_id, &msg , packet1.altitude_monotonic , packet1.altitude_amsl , packet1.altitude_local , packet1.altitude_relative , packet1.altitude_terrain , packet1.bottom_clearance );
	mavlink_msg_altitude_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_altitude_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.altitude_monotonic , packet1.altitude_amsl , packet1.altitude_local , packet1.altitude_relative , packet1.altitude_terrain , packet1.bottom_clearance );
	mavlink_msg_altitude_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_altitude_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_altitude_send(MAVLINK_COMM_1 , packet1.altitude_monotonic , packet1.altitude_amsl , packet1.altitude_local , packet1.altitude_relative , packet1.altitude_terrain , packet1.bottom_clearance );
	mavlink_msg_altitude_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_vehicle_ref_s(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_vehicle_ref_s_t packet_in = {
		17.0,45.0,73.0,101.0,129.0,157.0,185.0,213.0,241.0,269.0,297.0,325.0,353.0,381.0,409.0,185,252,63
    };
	mavlink_vehicle_ref_s_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.x_ref = packet_in.x_ref;
        	packet1.y_ref = packet_in.y_ref;
        	packet1.z_ref = packet_in.z_ref;
        	packet1.vx_ref = packet_in.vx_ref;
        	packet1.vy_ref = packet_in.vy_ref;
        	packet1.vz_ref = packet_in.vz_ref;
        	packet1.accx_ref = packet_in.accx_ref;
        	packet1.accy_ref = packet_in.accy_ref;
        	packet1.accz_ref = packet_in.accz_ref;
        	packet1.yaw_ref = packet_in.yaw_ref;
        	packet1.yaw_speed_ref = packet_in.yaw_speed_ref;
        	packet1.servo1 = packet_in.servo1;
        	packet1.servo2 = packet_in.servo2;
        	packet1.servo3 = packet_in.servo3;
        	packet1.servo4 = packet_in.servo4;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vehicle_ref_s_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_vehicle_ref_s_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vehicle_ref_s_pack(system_id, component_id, &msg , packet1.x_ref , packet1.y_ref , packet1.z_ref , packet1.vx_ref , packet1.vy_ref , packet1.vz_ref , packet1.accx_ref , packet1.accy_ref , packet1.accz_ref , packet1.yaw_ref , packet1.yaw_speed_ref , packet1.cmd1 , packet1.cmd2 , packet1.cmd3 , packet1.servo1 , packet1.servo2 , packet1.servo3 , packet1.servo4 );
	mavlink_msg_vehicle_ref_s_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vehicle_ref_s_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.x_ref , packet1.y_ref , packet1.z_ref , packet1.vx_ref , packet1.vy_ref , packet1.vz_ref , packet1.accx_ref , packet1.accy_ref , packet1.accz_ref , packet1.yaw_ref , packet1.yaw_speed_ref , packet1.cmd1 , packet1.cmd2 , packet1.cmd3 , packet1.servo1 , packet1.servo2 , packet1.servo3 , packet1.servo4 );
	mavlink_msg_vehicle_ref_s_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_vehicle_ref_s_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vehicle_ref_s_send(MAVLINK_COMM_1 , packet1.x_ref , packet1.y_ref , packet1.z_ref , packet1.vx_ref , packet1.vy_ref , packet1.vz_ref , packet1.accx_ref , packet1.accy_ref , packet1.accz_ref , packet1.yaw_ref , packet1.yaw_speed_ref , packet1.cmd1 , packet1.cmd2 , packet1.cmd3 , packet1.servo1 , packet1.servo2 , packet1.servo3 , packet1.servo4 );
	mavlink_msg_vehicle_ref_s_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_adc_status(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_adc_status_t packet_in = {
		5,72,139
    };
	mavlink_adc_status_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.adc_port1 = packet_in.adc_port1;
        	packet1.adc_port2 = packet_in.adc_port2;
        	packet1.bucket_status = packet_in.bucket_status;
        
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_adc_status_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_adc_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_adc_status_pack(system_id, component_id, &msg , packet1.adc_port1 , packet1.adc_port2 , packet1.bucket_status );
	mavlink_msg_adc_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_adc_status_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.adc_port1 , packet1.adc_port2 , packet1.bucket_status );
	mavlink_msg_adc_status_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_adc_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_adc_status_send(MAVLINK_COMM_1 , packet1.adc_port1 , packet1.adc_port2 , packet1.bucket_status );
	mavlink_msg_adc_status_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_vehicle_mea_s(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_vehicle_mea_s_t packet_in = {
		17.0,45.0,73.0,101.0,129.0,157.0,185.0,213.0,241.0,113,180,247,58,125,192,3,70,137
    };
	mavlink_vehicle_mea_s_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.x = packet_in.x;
        	packet1.y = packet_in.y;
        	packet1.z = packet_in.z;
        	...
        	packet1.pitch = packet_in.pitch;
        	packet1.yaw = packet_in.yaw;
        	packet1.xy_valid = packet_in.xy_valid;
        	packet1.z_valid = packet_in.z_valid;
        	packet1.v_xy_valid = packet_in.v_xy_valid;
        	packet1.v_z_valid = packet_in.v_z_valid;
        	packet1.ned_valid = packet_in.ned_valid;
        	packet1.yaw_valid = packet_in.yaw_valid;
        	packet1.cmd1 = packet_in.cmd1;
        	packet1.cmd2 = packet_in.cmd2;
        	packet1.cmd3 = packet_in.cmd3;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vehicle_mea_s_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_vehicle_mea_s_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vehicle_mea_s_pack(system_id, component_id, &msg , packet1.xy_valid , packet1.z_valid , packet1.v_xy_valid , packet1.v_z_valid , packet1.ned_valid , packet1.yaw_valid , packet1.x , packet1.y , packet1.z , packet1.vx , packet1.vy , packet1.vz , packet1.roll , packet1.pitch , packet1.yaw , packet1.cmd1 , packet1.cmd2 , packet1.cmd3 );
	mavlink_msg_vehicle_mea_s_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vehicle_mea_s_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.xy_valid , packet1.z_valid , packet1.v_xy_valid , packet1.v_z_valid , packet1.ned_valid , packet1.yaw_valid , packet1.x , packet1.y , packet1.z , packet1.vx , packet1.vy , packet1.vz , packet1.roll , packet1.pitch , packet1.yaw , packet1.cmd1 , packet1.cmd2 , packet1.cmd3 );
	mavlink_msg_vehicle_mea_s_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_vehicle_mea_s_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vehicle_mea_s_send(MAVLINK_COMM_1 , packet1.xy_valid , packet1.z_valid , packet1.v_xy_valid , packet1.v_z_valid , packet1.ned_valid , packet1.yaw_valid , packet1.x , packet1.y , packet1.z , packet1.vx , packet1.vy , packet1.vz , packet1.roll , packet1.pitch , packet1.yaw , packet1.cmd1 , packet1.cmd2 , packet1.cmd3 );
	mavlink_msg_vehicle_mea_s_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_servo_value(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_servo_value_t packet_in = {
		17.0,45.0,73.0,101.0,129.0,157.0
    };
	mavlink_servo_value_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.servo1 = packet_in.servo1;
        	packet1.servo2 = packet_in.servo2;
        	packet1.servo3 = packet_in.servo3;
        	packet1.servo4 = packet_in.servo4;
        	packet1.servo5 = packet_in.servo5;
        	packet1.servo6 = packet_in.servo6;
        
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_servo_value_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_servo_value_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_servo_value_pack(system_id, component_id, &msg , packet1.servo1 , packet1.servo2 , packet1.servo3 , packet1.servo4 , packet1.servo5 , packet1.servo6 );
	mavlink_msg_servo_value_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_servo_value_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.servo1 , packet1.servo2 , packet1.servo3 , packet1.servo4 , packet1.servo5 , packet1.servo6 );
	mavlink_msg_servo_value_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_servo_value_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_servo_value_send(MAVLINK_COMM_1 , packet1.servo1 , packet1.servo2 , packet1.servo3 , packet1.servo4 , packet1.servo5 , packet1.servo6 );
	mavlink_msg_servo_value_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_rfid_tag(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_rfid_tag_t packet_in = {
		93372036854775807ULL,963497880,101.0,129.0,157.0,185.0,18691,"EFGHIJKLMNOPQRSTUVWXYZABCDEFGHIJKLMNOPQ",87
    };
	mavlink_rfid_tag_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	...
        	packet1.z = packet_in.z;
        	packet1.yaw = packet_in.yaw;
        	packet1.position_tag = packet_in.position_tag;
        	packet1.ReadCount = packet_in.ReadCount;
        
        	mav_array_memcpy(packet1.tag_ID, packet_in.tag_ID, sizeof(char)*40);
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_rfid_tag_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_rfid_tag_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_rfid_tag_pack(system_id, component_id, &msg , packet1.tag_ID , packet1.timestamp , packet1.RSSI , packet1.ReadCount , packet1.x , packet1.y , packet1.z , packet1.yaw , packet1.position_tag );
	mavlink_msg_rfid_tag_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_rfid_tag_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.tag_ID , packet1.timestamp , packet1.RSSI , packet1.ReadCount , packet1.x , packet1.y , packet1.z , packet1.yaw , packet1.position_tag );
	mavlink_msg_rfid_tag_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_rfid_tag_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_rfid_tag_send(MAVLINK_COMM_1 , packet1.tag_ID , packet1.timestamp , packet1.RSSI , packet1.ReadCount , packet1.x , packet1.y , packet1.z , packet1.yaw , packet1.position_tag );
	mavlink_msg_rfid_tag_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_vtol_state(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_vtol_state_t packet_in = {
		5
    };
	mavlink_vtol_state_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vtol_state_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_vtol_state_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vtol_state_pack(system_id, component_id, &msg , packet1.state );
	mavlink_msg_vtol_state_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vtol_state_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.state );
	mavlink_msg_vtol_state_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_vtol_state_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_vtol_state_send(MAVLINK_COMM_1 , packet1.state );
	mavlink_msg_vtol_state_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_vehicle_ref_s(system_id, component_id, last_msg);
	mavlink_test_adc_status(system_id, component_id, last_msg);
	mavlink_test_vehicle_mea_s(system_id, component_id, last_msg);
	mavlink_test_servo_value(system_id, component_id, last_msg);
	mavlink_test_rfid_tag(system_id, component_id, last_msg);
	...
	mavlink_test_vtol_state(system_id, component_id, last_msg);
