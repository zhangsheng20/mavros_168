...
typedef struct __mavlink_heartbeat_t
{
 ...
 uint8_t rc_status; /*<  RC status, RC lost or not */
...
#define MAVLINK_MSG_ID_HEARTBEAT_CRC 207
...
#define MAVLINK_MESSAGE_INFO_HEARTBEAT { \
	...
	{  { "custom_mode", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_heartbeat_t, custom_mode) }, \
         ...
         { "rc_status", NULL, MAVLINK_TYPE_UINT8_T, 0, 8, offsetof(mavlink_heartbeat_t, rc_status) }, \
         { "mavlink_version", NULL, MAVLINK_TYPE_UINT8_T, 0, 9, offsetof(mavlink_heartbeat_t, mavlink_version) }, \
         } \
}
 ...
 * @param rc_status  RC status, RC lost or not 
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_heartbeat_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint8_t type, uint8_t autopilot, uint8_t base_mode, uint32_t custom_mode, uint8_t system_status, uint8_t rc_status)
{
	...
	_mav_put_uint8_t(buf, 8, rc_status);
	_mav_put_uint8_t(buf, 9, 3);
...
{
	return mavlink_msg_heartbeat_pack(system_id, component_id, msg, heartbeat->type, heartbeat->autopilot, heartbeat->base_mode, heartbeat->custom_mode, heartbeat->system_status, heartbeat->rc_status);
}
...
{
	return mavlink_msg_heartbeat_pack_chan(system_id, component_id, chan, msg, heartbeat->type, heartbeat->autopilot, heartbeat->base_mode, heartbeat->custom_mode, heartbeat->system_status, heartbeat->rc_status);
}
...
static inline void mavlink_msg_heartbeat_send(mavlink_channel_t chan, uint8_t type, uint8_t autopilot, uint8_t base_mode, uint32_t custom_mode, uint8_t system_status, uint8_t rc_status)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_HEARTBEAT_LEN];
	_mav_put_uint32_t(buf, 0, custom_mode);
 ...
 */
static inline void mavlink_msg_heartbeat_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t type, uint8_t autopilot, uint8_t base_mode, uint32_t custom_mode, uint8_t system_status, uint8_t rc_status)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field rc_status from heartbeat message
 *
 * @return  RC status, RC lost or not 
 */
static inline uint8_t mavlink_msg_heartbeat_get_rc_status(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_heartbeat_decode(const mavlink_message_t* msg, mavlink_heartbeat_t* heartbeat)
{
	...
	heartbeat->rc_status = mavlink_msg_heartbeat_get_rc_status(msg);
