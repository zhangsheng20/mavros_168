...
private:
	...
	ros::Subscriber mavref_sub;
	ros::Subscriber mavmea_sub;
	ros::Publisher mavlink_gcs_to_pixhawk_pub;
	ros::Subscriber mavlink_pixhaw_to_gcs_sub;
	ros::Subscriber mavlink_ros_to_gcs_sub;
	...
	int tgt_system_id_, tgt_component_id_;

	int local_pos_recv_count;
	int att_recv_count;
	int global_pos_recv_count;
	...
	void mavref_sub_cb(const Mavlink::ConstPtr &rmsg);
	void mavmea_sub_cb(const Mavlink::ConstPtr &rmsg);
	void mavlink_gcs_to_pixhawk_pub_cb(const mavlink_message_t *mmsg, uint8_t sysid, uint8_t compid);
	void mavlink_pixhaw_to_gcs_sub_cb(const Mavlink::ConstPtr &rmsg);
