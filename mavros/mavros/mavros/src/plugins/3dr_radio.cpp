...
public:
			...
			diagnostic_updater::Updater &diag_updater)
	{
		...
		for (uint8_t i = 0; i < uav_sys_id_list_.size(); i++)
        {
            ...
            status_pub_list_.push_back(nh.advertise<mavros::RadioStatus>("radio_status" + sys_id, 10));
        }
	}
...
private:
	...
	std::vector<ros::Publisher> status_pub_list_;
...
#undef RST_COPY
		...
		publishMessage(sysid, compid, status_pub_list_, msg);
	}
};
